...
const char *CMSS_Player::GetPlayerModelSoundPrefix( void )
{
	return g_ppszPlayerSoundPrefixNames[m_iPlayerSoundType];
}

void CMSS_Player::PrecacheFootStepSounds( void )
{
...
CPlayerAnimState::CPlayerAnimState( CMSS_Player *outer )
	: m_pOuter( outer )
{
	m_flGaitYaw = 0.0f;
...
// Output : CBasePlayer
//-----------------------------------------------------------------------------
CMSS_Player *CPlayerAnimState::GetOuter()
{
	return m_pOuter;
}
