...
IMPLEMENT_NETWORKCLASS_ALIASED( BaseMSSBludgeonWeapon, DT_BaseMSSBludgeonWeapon )

BEGIN_NETWORK_TABLE( CBaseMSSBludgeonWeapon, DT_BaseMSSBludgeonWeapon )
END_NETWORK_TABLE()
...
//-----------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::Spawn( void )
{
	m_fMinRange1	= 0;
	m_fMinRange2	= 0;
	m_fMaxRange1	= 64;
...
//-----------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::Precache( void )
{
	//Call base class first
	BaseClass::Precache();
}
...
//------------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::ItemPostFrame( void )
{
...
// Output  :
//------------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::SecondaryAttack()
{
	Swing( true );
}
...
//------------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::Hit( trace_t &traceHit, Activity nHitActivity )
{
...
Activity CBaseMSSBludgeonWeapon::ChooseIntersectionPointAndActivity( trace_t &hitTrace, const Vector &mins, const Vector &maxs, CBasePlayer *pOwner )
{
	int			i, j, k;
	float		distance;
...
// Input  : &traceHit - 
//-----------------------------------------------------------------------------
bool CBaseMSSBludgeonWeapon::ImpactWater( const Vector &start, const Vector &end )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::ImpactEffect( trace_t &traceHit )
{
...
//------------------------------------------------------------------------------
void CBaseMSSBludgeonWeapon::Swing( int bIsSecondary )
{
	trace_t traceHit;
