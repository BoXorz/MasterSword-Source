...
abstract_class CBaseRat : public CAI_BaseNPC
{
	DECLARE_CLASS( CBaseRat, CAI_BaseNPC );
...
// BOXBOX The basic rat

class CRat : public CBaseRat
{
	DECLARE_CLASS( CRat, CBaseRat );
...
// BOXBOX The larger, tougher Rat

class CLargeRat : public CBaseRat
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CLargeRat, CBaseRat );
...
// BOXBOX The Huge Boss Rat!

class CBossRat : public CBaseRat
{
	DECLARE_CLASS( CBossRat, CBaseRat );
